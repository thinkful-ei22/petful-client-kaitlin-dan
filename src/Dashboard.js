...
import { fetchCat, fetchDog, fetchAdoptCat, fetchAdoptDog } from './actions/index';
import './grid.css';
  ...
  return (
    <main className='row'>
      <h1>Save a <span>Life</span>. Adopt a Pet!</h1>
        <Pet Pet={this.props.catToAdopt.data} onAdoptPet={() => this.handleOnAdoptCat()} />
      <Pet Pet={this.props.dogToAdopt.data} onAdoptPet={() => this.handleOnAdoptDog()} />
    </main>
    )
  }
}
